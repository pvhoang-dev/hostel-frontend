...
const FilterSection = ({ filters, onFilterChange, onClearFilters, onApplyFilters }) => (
...
const PaymentMethodList = () => {
    ...
    const { execute: deletePaymentMethod } = useApi(paymentMethodService.deletePaymentMethod);
