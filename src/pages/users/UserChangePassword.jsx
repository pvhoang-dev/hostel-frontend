                ...
                <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-3">
                            ...
                            <input
                                ...
                                className={`form-control ${
                                    (validationErrors.current_password || errors.current_password) ? "is-invalid" : ""
                                }`}
                            />
                            {validationErrors.current_password && (
                                <div className="invalid-feedback">{validationErrors.current_password}</div>
                            )}
                    ...
                    <div className="mb-3">
                        ...
                        <input
                            ...
                            onChange={handleChange}
                            className={`form-control ${
                                (validationErrors.new_password || errors.new_password) ? "is-invalid" : ""
                            }`}
                        />
                        {validationErrors.new_password && (
                            <div className="invalid-feedback">{validationErrors.new_password}</div>
                        )}
                        {errors.new_password && (
                    ...
                    <div className="mb-3">
                        ...
                        <input
                            ...
                            onChange={handleChange}
                            className={`form-control ${
                                (validationErrors.new_password_confirmation || errors.new_password_confirmation)
                                    ? "is-invalid" : ""
                            }`}
                        />
