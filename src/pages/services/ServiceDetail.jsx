            ...
            <Card>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <p className="mt-1 text-lg text-gray-900">{service.default_price?.toLocaleString()} VND</p> {/* Format price */}
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <p className={`mt-1 text-lg ${service.is_metered ? 'text-green-600' : 'text-red-600'}`}>
                            {service.is_metered ? "Yes" : "No"}
                        </p>
                    </div>
                    <div>
                        <p className="text-sm font-medium text-gray-500">Created At</p>
                        <p className="mt-1 text-sm text-gray-900">{new Date(service.created_at).toLocaleString()}</p>
                    </div>
                    <div>
                        <p className="text-sm font-medium text-gray-500">Last Updated At</p>
                        <p className="mt-1 text-sm text-gray-900">{new Date(service.updated_at).toLocaleString()}</p>
                    </div>
                </div>
